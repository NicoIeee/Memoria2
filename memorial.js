...
const ambientLight = new THREE.AmbientLight(0xfff2df, 1.2);
...
const letterFiles = [
  {
    key: "M1",
    label: "M",
    file: "models/M1%20memoria.glb",
    x: -9
  },
  {
    key: "E",
    label: "E",
    file: "models/E%20memoria.glb",
    x: -6
  },
  {
    key: "M2",
    label: "M",
    file: "models/M2%20memoria.glb",
    x: -3
  },
  {
    key: "O",
    label: "O",
    file: "models/O%20memoria.glb",
    x: 0
  },
  {
    key: "R",
    label: "R",
    file: "models/R%20memoria.glb",
    x: 3
  },
  {
    key: "I",
    label: "I",
    file: "models/I%20memoria.glb",
    x: 6
  },
  {
    key: "A",
    label: "A",
    file: "models/A%20memoria.glb",
    x: 9
  }
];
  ...
  surfaces.forEach(surface => {
    for (let row = 0; row < surface.rows; row++) {
      for (let col = 0; col < surface.cols; col++) {
        ...
        const px =
          (col - (surface.cols - 1) / 2) *
          frameW *
          1.25;

        const py =
          (row - (surface.rows - 1) / 2) *
          frameH *
          1.25;
...
letterFiles.forEach(data => {
  ...
  button.addEventListener("click", () => {
    const letter = loadedLetters.find(
...
document.getElementById("isolateLetter").addEventListener("click", () => {
  ...
  loadedLetters.forEach(letter => {
    letter.object.visible =
      letter.key === selectedLetter.key;
  });
